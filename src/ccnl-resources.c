...
int ccnl_resource_handleInterest(struct ccnl_relay_s *ccnl, int suite, struct ccnl_prefix_s *pfx) {
	 ...
	 */
	char *url = ccnl_prefix_to_path(pfx);
	...
	//TODO: Delete the following commented code block
//	char *chunk_zero_segstr;
//	int chunk_zero_segstr_len;
//	if(suite == CCNL_SUITE_CCNTLV)
//		chunk_zero_segstr = "%00";
//	else if (suite == CCNL_SUITE_NDNTLV)
//		chunk_zero_segstr = "%00%00";
//	chunk_zero_segstr_len = strlen(chunk_zero_segstr);
